...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        ...
        Title="ADUC-PS v.0.4" Height="600" Width="400" WindowStartupLocation="CenterScreen"
        Background="Black">
        <Grid Margin="10">
        <Grid.RowDefinitions>
        ...
        <!-- Title -->
        <TextBlock Text="ADUC-PS v0.4" FontSize="20" FontWeight="Bold" Grid.Row="0" VerticalAlignment="Top" HorizontalAlignment="Center" Margin="0,10" Foreground="White"/>
            <Grid Grid.Row="1" Grid.Column="0">
            
        <!-- Buttons Section -->
        <StackPanel x:Name="ButtonsPanel" Grid.Row="1" Grid.Column="0" HorizontalAlignment="Center" VerticalAlignment="Top" Width="300">
    ...
    <!-- Expanded Section for User creation -->
        ...
        <!-- "Enter users first name" label and textbox -->
            ...
            <TextBox Name="txtUserFirstName" Width="280" Height="25" Background="White" 
        ...
        <!-- "Enter users last name" label and textbox -->
            ...
            <TextBox Name="txtUserLastName" Width="280" Height="25" Background="White" 
        ...
        <!-- "Enter domain" label and textbox -->
            ...
            <TextBox Name="txtUPN" Width="280" Height="25" Background="White" 
        ...
        <!-- "Enter password" label and textbox -->
            ...
            <TextBox Name="txtPassword" Width="280" Height="25" Background="White" 
        ...
        <!-- "Users OU" label and combobox -->
            ...
            <ComboBox Name="cbUserOU" Width="280" Background="Black" Foreground="Black" BorderBrush="Gray"
        ...
        <!-- "Select security group" label and combobox -->
            ...
            <ComboBox Name="cbUserSecGroup" Width="280" Background="Black" Foreground="Black" BorderBrush="Gray"
        ...
        <!-- "Enter Security Group Name" label and texbox-->
            <TextBlock Text="Enter Security Group name:" FontSize="14" Foreground="White" 
                Grid.Row="0" Margin="0,10,0,5"/>
            <TextBox Name="txtSecGroupName" Width="280" Height="25" Background="White" 
                Foreground="Black" BorderBrush="Gray" Grid.Row="1"/>

        <!-- "Select OU" label and combobox -->
            <TextBlock Text="Select OU:" FontSize="14" Foreground="White" 
                Grid.Row="2" Margin="0,10,0,5"/>
            <ComboBox Name="cbSecGroupOU" Width="280" Background="White" 
                Foreground="Black" BorderBrush="Gray" Grid.Row="3"/>
        ...
        <!-- "Select group scope" text and combobox -->
            ...
            <ComboBox Name="cbGroupScope" Width="280" Background="Black" Foreground="Black" BorderBrush="Gray" Grid.Row="5">
